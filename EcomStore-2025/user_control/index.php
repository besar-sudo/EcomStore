...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      ...
      $message[] = 'Adding the product to your cart!';
   }
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Remove item from the shopping cart?');">Delete</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index.php?delete_all" onclick="return confirm('Delete all items from the cart');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Delete all</a></td>
      </tr>
   </tbody>
   </table>
